...
public class DisplayDiffirenceBetweenNumbersAction implements Action {
   //todo изменить названия
    ...
    public void invoke() {
        ...
        TaskOneService.displayDifferenceBetweenTwoNumbersAndThirdNumber(numberOne,numberSecond,numberThree);
    }
}
